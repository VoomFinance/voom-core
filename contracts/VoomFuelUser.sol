...
contract VoomFuelUser  {
    ...
    ICakePool public Pool = ICakePool(0x86f4bC1EBf2C209D12d3587B7085aEA5707d4B56);
    IBEP20 public lp = IBEP20(0x3763A3263CEaca5e7Cc1Bc22A43920bAd9f743Cd);
    ICakePool public lpCake = ICakePool(0x3763A3263CEaca5e7Cc1Bc22A43920bAd9f743Cd);
    ...
    IBEP20 public fuel = IBEP20(0x2090c8295769791ab7A3CF1CC6e0AA19F35e441A);
    ...
    function pending() external view returns (uint256) {
        return Pool.pendingFuel(pid, address(this));
    }
