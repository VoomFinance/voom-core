...
import "./VoomCakeUser.sol";
import "./interfaces/IPool.sol";

contract VoomCake is Ownable  {

    using SafeMath for uint256;

    mapping(address => bool) public mod;

    VoomCakeUser[] public vooms;
    ...
    function createVoom(address ref) external {
        ...
        VoomCakeUser _voom = new VoomCakeUser(msg.sender, member, dev, chef, address(this), userCountVooms[msg.sender]);
        vooms.push(_voom);
